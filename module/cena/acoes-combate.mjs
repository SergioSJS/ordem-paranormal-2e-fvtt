...
import { personagensDaCenaAtiva, npcsDaCenaAtiva } from "./encerrar-investigacao.mjs";
...
/** Alvos possíveis: todo mundo na investigação, menos quem ataca. */
async function escolherAlvo(ator) {
  const candidatos = [...personagensDaCenaAtiva(), ...npcsDaCenaAtiva()].filter((a) => a.id !== ator.id);
